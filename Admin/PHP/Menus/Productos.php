                        ...
                        <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    <form id="product-form" method="post" action="RegistrarProducto.php"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="product-code" name="CodigoProducto"
                                                class="form-control" required>
                                            <span id="errorproduct-code" class="text-danger"></span>
                                        </div>
                                        <div class="mb-3">
                                            <label for="product-name">Nombre del Producto:</label>
                                            <input type="text" id="product-name" name="Nombre" class="form-control"
                                                required>
                                            <span id="errorproduct-name" class="text-danger"></span>
                                        </div>
                                        <div class="mb-3">
                                            <label for="product-description">Descripción:</label>
                                            <textarea id="product-description" name="Descripcion" class="form-control"
                                                required></textarea>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select id="product-category" name="IdCategoria" class="form-control"
                                                required>
                            ...
                            ?>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="file" id="product-images" name="ImagenProducto"
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $registro["Stock"] != null ? $registro["Stock"] : "N/A"; ?>
                                        </td>
                                        <td>
                                            <?php echo $registro["Talla"] != null ? $registro["Talla"] : "N/A"; ?>
                                        </td>
                                        <td>
                                            <?php echo $registro["Color"]; ?>
                                        </td>
                                        <td>
                                            <?php echo $registro["CategoriaNombre"]; ?>
                                        </td>
                                        <td>
                                            <?php echo $registro["PrecioUnitario"]; ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php echo basename($registro["ImagenProducto"]); ?>
                                        </td>
                                        <td>
